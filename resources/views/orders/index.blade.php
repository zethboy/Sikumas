...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-4">
                ...
                <div class="flex justify-between items-center mt-3 pt-3 border-t border-gray-50">
                    ...
                    <a href="{{ route('orders.show', $order) }}" class="text-green-600 font-semibold hover:underline text-sm">Detail →</a>
                </div>
            </div>
        </div>
        @empty
        <div class="bg-white p-8 rounded-xl text-center text-gray-500">
            ...
            <a href="{{ route('products.index') }}" class="text-green-600 hover:underline mt-2 inline-block">Mulai Belanja</a>
        </div>
        @endforelse
    </div>
</div>
